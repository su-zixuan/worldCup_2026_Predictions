...
def simulate_knockout_round(
    ...
    for i in range(0, len(teams), 2):
        ...
        features = make_prediction_features(results, team_a, team_b, neutral=True)
...
def simulate_knockout_tournament(
    ...
    while len(current) > 1:
        ...
        current, matches = simulate_knockout_round(results, model, current, round_name, seed=round_seed)
